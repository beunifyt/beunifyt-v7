...
const MOD='flota',COLL='movimientos',TITLE='Embalaje',ICON='📦',REQ_FIELD='codigo';
const HAS_ESPECIAL=false; // Ingresos SÍ tiene subtab Especial
const FIELD_DEFS={
  paquete:{icon:'📦',label:'Paquete',fields:[
    {id:'codigo',label:'Código',req:1,desc:'Código paquete',type:'text'},
    {id:'descripcion',label:'Descripción',desc:'Detalle contenido',type:'text'},
    {id:'tipo',label:'Tipo',desc:'Empty/Fullgood',type:'select',options:['','Empty','Fullgood']},
    {id:'peso',label:'Peso (kg)',desc:'Peso en kg',type:'number'},
    {id:'dimensiones',label:'Dimensiones',desc:'L x A x H',type:'text'},
    {id:'fragil',label:'Frágil',desc:'Requiere cuidado',type:'select',options:['No','Sí']},
  ]},
  destino:{icon:'📍',label:'Destino',fields:[
    {id:'hall',label:'Hall',req:1,desc:'Hall destino',type:'text'},
    {id:'stand',label:'Stand',desc:'Stand destino',type:'text'},
    {id:'expositor',label:'Expositor',desc:'Expositor destino',type:'text'},
    {id:'referencia',label:'Referencia',desc:'Ref/Booking',type:'text'},
  ]},
  logistica:{icon:'🚛',label:'Logística',fields:[
...
const ALL_COLS=[{id:'pos',label:'#',req:1},{id:'codigo',label:'Código',req:1},{id:'descripcion',label:'Descripción'},{id:'tipo',label:'Tipo'},{id:'peso',label:'Peso'},{id:'hall',label:'Hall'},{id:'stand',label:'Stand'},{id:'expositor',label:'Expositor'},{id:'empresa',label:'Empresa'},{id:'estado',label:'Estado'},{id:'entrada',label:'Fecha'},{id:'acciones',label:'Acc.',req:1}];
...
const ST={RECIBIDO:'Recibido',ENTREGADO:'Entregado',PENDIENTE:'Pendiente',DEVUELTO:'Devuelto'};
const ST_BG={RECIBIDO:'#dcfce7;color:#15803d',ENTREGADO:'#dbeafe;color:#1d4ed8',PENDIENTE:'#fef9c3;color:#a16207',DEVUELTO:'#f1f5f9;color:#64748b'};
...
const PFX='_fl'; // prefix para window bindings único
