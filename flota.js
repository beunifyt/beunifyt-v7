...
// Colección: movimientos | Empty (embalaje) y Fullgood (mercadería valor)
// Cross-read: conductores
// ═══════════════════════════════════════════════════════════
...
const ALL_COLS=[{id:'pos',label:'#',req:1},{id:'codigo',label:'Código',req:1},{id:'descripcion',label:'Descripción'},{id:'tipo',label:'Tipo'},{id:'peso',label:'Peso'},{id:'hall',label:'Hall'},{id:'stand',label:'Stand'},{id:'empresa',label:'Empresa'},{id:'estado',label:'Estado'},{id:'entrada',label:'Fecha'},{id:'acciones',label:'Acc.',req:1}];
