...
function goTab(tab) {
  ...
  const map = {
    ...
    analytics2:  function(){ if(window.renderAnalytics2) window.renderAnalytics2(); else toast('Event Tracker no cargado','var(--amber)'); },
    analytics3:  function(){ if(window.renderAnalytics3) window.renderAnalytics3(); else toast('Precision Analytics no cargado','var(--amber)'); },
    analytics4:  function(){ if(window.renderAnalytics4) window.renderAnalytics4(); else toast('AI Intelligence no cargado','var(--amber)'); },
