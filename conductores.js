...
const FIELD_DEFS={
  personal:{icon:'👤',label:'Personal',fields:[
    ...
    {id:'dni',label:'DNI/Pasaporte',desc:'Documento',type:'text'},
    {id:'telefono',label:'Teléfono',desc:'Tel. móvil',type:'tel'},
    {id:'telPais',label:'Prefijo',desc:'Código país',type:'select',options:['+34 🇪🇸','+33 🇫🇷','+49 🇩🇪','+48 🇵🇱','+39 🇮🇹','+44 🇬🇧']},
    {id:'email',label:'Email',desc:'Correo electrónico',type:'text'},
    {id:'nacionalidad',label:'Nacionalidad',desc:'País de origen',type:'text'},
  ]},
  profesional:{icon:'🚛',label:'Profesional',fields:[
    {id:'empresa',label:'Empresa',desc:'Empresa transportista',type:'text'},
    {id:'licencia',label:'Licencia',desc:'Tipo licencia',type:'select',options:['','B','C','C+E','D','Otro']},
    {id:'vehiculo',label:'Vehículo habitual',desc:'Matrícula habitual',type:'text'},
    {id:'idiomas',label:'Idiomas',desc:'Idiomas que habla',type:'text'},
