...
export const I18N={
  es:{dash:'📊 Dashboard',ingresos:'🔖 Referencia',ingresos2:'🚛 Ingresos',flota:'📦 Embalaje',conductores:'👤 Conductores',agenda:'📅 Agenda',analytics:'📈 Análisis',analytics2:'🎯 Event Tracker',analytics3:'📈 Precision',analytics4:'🤖 AI Intel',vehiculos:'📜 Historial',auditoria:'📂 Archivos',recintos:'🏟 Recintos',usuarios:'👥 Usuarios',eventos:'📅 Eventos',papelera:'🗑 Papelera',mensajes:'📢 Mensajes',lang_ok:'Idioma guardado',impresion:'🖨 Impresión'},
  en:{dash:'📊 Dashboard',ingresos:'🔖 Reference',ingresos2:'🚛 Access',flota:'📦 Packaging',conductores:'👤 Drivers',agenda:'📅 Agenda',analytics:'📈 Analytics',analytics2:'🎯 Event Tracker',analytics3:'📈 Precision',analytics4:'🤖 AI Intel',vehiculos:'📜 History',auditoria:'📂 Files',recintos:'🏟 Venues',usuarios:'👥 Users',eventos:'📅 Events',papelera:'🗑 Trash',mensajes:'📢 Messages',lang_ok:'Language saved',impresion:'🖨 Print'},
  fr:{dash:'📊 Tableau',ingresos:'🔖 Référence',ingresos2:'🚛 Accès',flota:'📦 Emballage',conductores:'👤 Chauffeurs',agenda:'📅 Agenda',analytics:'📈 Analytique',analytics2:'🎯 Suivi',analytics3:'📈 Précision',analytics4:'🤖 IA Intel',vehiculos:'📜 Historique',auditoria:'📂 Fichiers',recintos:'🏟 Lieux',usuarios:'👥 Utilisateurs',eventos:'📅 Événements',papelera:'🗑 Corbeille',mensajes:'📢 Messages',lang_ok:'Langue sauvegardée',impresion:'🖨 Impression'},
  de:{dash:'📊 Dashboard',ingresos:'🔖 Referenz',ingresos2:'🚛 Zugang',flota:'📦 Verpackung',conductores:'👤 Fahrer',agenda:'📅 Agenda',analytics:'📈 Analytik',analytics2:'🎯 Tracker',analytics3:'📈 Präzision',analytics4:'🤖 KI Intel',vehiculos:'📜 Verlauf',auditoria:'📂 Dateien',recintos:'🏟 Veranstaltungsorte',usuarios:'👥 Benutzer',eventos:'📅 Events',papelera:'🗑 Papierkorb',mensajes:'📢 Nachrichten',lang_ok:'Sprache gespeichert',impresion:'🖨 Druck'},
  pl:{dash:'📊 Pulpit',ingresos:'🔖 Referencja',ingresos2:'🚛 Wejścia',flota:'📦 Pakowanie',conductores:'👤 Kierowcy',agenda:'📅 Agenda',analytics:'📈 Analityka',analytics2:'🎯 Śledzenie',analytics3:'📈 Precyzja',analytics4:'🤖 AI Intel',vehiculos:'📜 Historia',auditoria:'📂 Pliki',recintos:'🏟 Obiekty',usuarios:'👥 Użytkownicy',eventos:'📅 wydarzenia',papelera:'🗑 Kosz',mensajes:'📢 Wiadomości',lang_ok:'Język zapisany',impresion:'🖨 Druk'},
  ro:{dash:'📊 Panou',ingresos:'🔖 Referință',ingresos2:'🚛 Intrări',flota:'📦 Ambalare',conductores:'👤 Șoferi',agenda:'📅 Agendă',analytics:'📈 Analiză',analytics2:'🎯 Urmărire',analytics3:'📈 Precizie',analytics4:'🤖 AI Intel',vehiculos:'📜 Istoric',auditoria:'📂 Fișiere',recintos:'🏟 Locații',usuarios:'👥 Utilizatori',eventos:'📅 Evenimente',papelera:'🗑 Coș',mensajes:'📢 Mesaje',lang_ok:'Limbă salvată',impresion:'🖨 Tipărire'},
  it:{dash:'📊 Dashboard',ingresos:'🔖 Riferimento',ingresos2:'🚛 Accessi',flota:'📦 Imballaggio',conductores:'👤 Autisti',agenda:'📅 Agenda',analytics:'📈 Analisi',analytics2:'🎯 Tracciamento',analytics3:'📈 Precisione',analytics4:'🤖 IA Intel',vehiculos:'📜 Cronologia',auditoria:'📂 File',recintos:'🏟 Sedi',usuarios:'👥 Utenti',eventos:'📅 Eventi',papelera:'🗑 Cestino',mensajes:'📢 Messaggi',lang_ok:'Lingua salvata',impresion:'🖨 Stampa'},
  cs:{dash:'📊 Dashboard',ingresos:'🔖 Reference',ingresos2:'🚛 Vstupy',flota:'📦 Balení',conductores:'👤 Řidiči',agenda:'📅 Agenda',analytics:'📈 Analýza',analytics2:'🎯 Sledování',analytics3:'📈 Přesnost',analytics4:'🤖 AI Intel',vehiculos:'📜 Historie',auditoria:'📂 Soubory',recintos:'🏟 Prostory',usuarios:'👥 Uživatelé',eventos:'📅 Události',papelera:'🗑 Koš',mensajes:'📢 Zprávy',lang_ok:'Jazyk uložen',impresion:'🖨 Tisk'},
  nl:{dash:'📊 Dashboard',ingresos:'🔖 Referentie',ingresos2:'🚛 Toegang',flota:'📦 Verpakking',conductores:'👤 Chauffeurs',agenda:'📅 Agenda',analytics:'📈 Analyse',analytics2:'🎯 Tracking',analytics3:'📈 Precisie',analytics4:'🤖 AI Intel',vehiculos:'📜 Geschiedenis',auditoria:'📂 Bestanden',recintos:'🏟 Locaties',usuarios:'👥 Gebruikers',eventos:'📅 Evenementen',papelera:'🗑 Prullenbak',mensajes:'📢 Berichten',lang_ok:'Taal opgeslagen',impresion:'🖨 Afdrukken'},
  pt:{dash:'📊 Painel',ingresos:'🔖 Referência',ingresos2:'🚛 Acessos',flota:'📦 Embalagem',conductores:'👤 Motoristas',agenda:'📅 Agenda',analytics:'📈 Análise',analytics2:'🎯 Rastreamento',analytics3:'📈 Precisão',analytics4:'🤖 IA Intel',vehiculos:'📜 Histórico',auditoria:'📂 Arquivos',recintos:'🏟 Recintos',usuarios:'👥 Usuários',eventos:'📅 Eventos',papelera:'🗑 Lixeira',mensajes:'📢 Mensagens',lang_ok:'Idioma salvo',impresion:'🖨 Impressão'},
  hu:{dash:'📊 Irányítópult',ingresos:'🔖 Referencia',ingresos2:'🚛 Belépés',flota:'📦 Csomagolás',conductores:'👤 Sofőrök',agenda:'📅 Napirend',analytics:'📈 Elemzés',analytics2:'🎯 Nyomkövetés',analytics3:'📈 Precizitás',analytics4:'🤖 MI Intel',vehiculos:'📜 Előzmények',auditoria:'📂 Fájlok',recintos:'🏟 Helyszínek',usuarios:'👥 Felhasználók',eventos:'📅 Események',papelera:'🗑 Szemetes',mensajes:'📢 Üzenetek',lang_ok:'Nyelv mentve',impresion:'🖨 Nyomtatás'}
};
