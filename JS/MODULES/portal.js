...
<div id="pSAPreviewBanner" style="display:none;background:#f59e0b;color:#fff;padding:6px 16px;font-size:12px;font-weight:700;text-align:center">
  👁 Modo preview SA — <button onclick="window._portal.exitPreview()" style="background:rgba(0,0,0,.2);border:none;color:#fff;padding:2px 10px;border-radius:10px;cursor:pointer;font-weight:700;font-size:12px">← Volver al operador</button>
</div>
<div id="pTabs">
