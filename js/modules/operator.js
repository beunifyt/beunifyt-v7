...
function renderIngresos() {
  ...
  h += '<button class="btn btn-sm btn-p" style="flex-shrink:0">📋 Lista</button>';
  h += '<button class="btn btn-sm btn-gh" style="flex-shrink:0" onclick="window._ingSub=\'listanegra\';window._op.renderIngresos()">⭐ Especial (' + (DB.listaNegra||[]).length + ')</button>';
  h += '<button class="btn btn-sm btn-gh" style="flex-shrink:0" onclick="window._op.goTab(\'vehiculos\')">✏️ Modif.</button>';
  h += '<button class="btn btn-sm btn-gh" style="flex-shrink:0" onclick="window._ingSub=\'espera\';window._op.renderIngresos()">⏳ En espera (' + (DB.enEspera||[]).filter(e=>e.estado==='pendiente').length + ')</button>';
  if (canCampos()) h += '<button class="btn btn-sm btn-gh" style="flex-shrink:0" onclick="window._ingSub=\'campos\';window._op.renderIngresos()">⊙ Campos</button>';
...
function renderIngresos2() {
  ...
  h += '<div style="display:flex;align-items:center;gap:3px;padding:4px 0;border-bottom:1px solid var(--border);margin-bottom:4px;overflow-x:auto;scrollbar-width:none;flex-wrap:nowrap">';
  h += '<button class="btn btn-sm btn-p" style="flex-shrink:0">📋 Lista</button>';
  h += '<button class="btn btn-sm btn-gh" style="flex-shrink:0" onclick="window._ingSub2=\'listanegra\';window._op.renderIngresos2()">⭐ Especial</button>';
  h += '<button class="btn btn-sm btn-gh" style="flex-shrink:0" onclick="window._op.goTab(\'vehiculos\')">✏️ Modif.</button>';
