// ═══════════════════════════════════════════════════════════
// BeUnifyT v8 — firestore.js — Adaptador Firebase
// Se carga SOLO cuando se necesita (login o resume)
// ═══════════════════════════════════════════════════════════
...
export async function fsQuery(collPath, ...queryFns) {
  const { collection, query, getDocs } = await import(`${FB}/firebase-firestore.js`);
